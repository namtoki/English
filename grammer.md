...
- Example
    - A: **Concentrate!**
    - B: **Be more confident.**
    - C: **Take a look at it**, man. It's awesome.
    - D: This apple pie is delicious. **Try it!**
    - E: **Don't** speak to me like that again, OK?
    - F: **Don't** be nervous.
    - G: **Let's** order pizza tonight.
    - H: No, **let's not** order pizza tonight.
    - I: **Let's** order pizza tonight, **shall we?**
- Description
    - Basic
        - (A, B, E) 高圧力の表現で、家族間でもなかなか使用しない
    - Exception
        - (C, D, F) 相手にとって好ましいことはその限りではない

### There 文
- Example
    - A: **There is** a strange-looking guy at the door.
    - B: A long time ago, **there was** a handsome young prince called Henry.
    - C: Tom is in the park
    - D: Your son is in the school yard at the moment.
    - E: He was in the car park.
- Description
    - Basic
        - (A, B) 初めて話題にのぼる事物を話題の中に引っ張りこんでくるときに使用される
    - Exception
