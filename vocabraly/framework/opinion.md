...
- [x] `It's not that (S) (V)`:                  `It's not like` Joe is a bad guy. He is just shady sometimes.
- [x] `It's not like (S) (V)`:
- [x] `It's just that (S) (V)`:
- [x] `It's more like (S) (V)`:
- [x] `It's more that (S) (V)`:
- [ ] `It's the fact that (S) (V)`:             But not because it's so big. `It's the fact that` it's so diverse.
...
- [ ] `I'd (V)`:                                `I'd` ask Tom.
- [x] `I say (S) (V)`:                          `I say` it's time you force the issue.
- [ ] `(S) be better off (N)`:                  You`'re better off` starting from the beginning than trying ...
- [x] `(S) should (V)`:                         We `should` ask first.
- [ ] `(S) (might) want to (V)`:                You `want to` pull your fingers in like this.
- [ ] `(S) might as well (V)`:                  You `might as well` walk home.
- [x] `it would be better if (S) (V)`:          `Would it be better if` I got wet?
- [x] `(S) have to (V)`:                        I `have to` go home.
- [x] `(S) gotta (V)`:                          I `gotta` go.
...
- [x] `(S) doesn't add up`:                     It `doesn't add up` at all.
