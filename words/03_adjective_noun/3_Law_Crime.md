...
> `compliance` /kəmˈplaɪəns/        ([Neutral] 遵守、コンプラ)      The company ensures compliance with regulations.
  ...
  - `conformity` /kənˈfɔːrməti/     ([Formal] 遵守、適合)           Conformity to standards is essential.
  - `obedience` /oʊˈbiːdiəns/       ([Neutral] 服従、遵守)          Obedience to the rules is expected.
...
> `acquittal` /əˈkwɪtəl/            ([Legal] 無罪判決)              The acquittal surprised everyone.
  - `exoneration` /ɪɡˌzɑːnəˈreɪʃən/ ([Formal] 無罪放免、潔白証明)   His exoneration came after new evidence.
  - `vindication` /ˌvɪndɪˈkeɪʃən/   ([Formal] 潔白証明、弁護)       The verdict was a vindication of her claims.
...
> `kidnapping` /ˈkɪdnæpɪŋ/          ([Neutral] 誘拐)                The kidnapping made national news.
  - `kidnap` /ˈkɪdnæp/              ([Neutral] 誘拐する、誘拐)      They tried to kidnap the child.
  - `abduction` /æbˈdʌkʃən/         ([Formal] 誘拐、拉致)           The abduction shocked the community.
  - `child abduction`               ([Formal] 児童誘拐)             Child abduction is a serious crime.
  - `snatch` /snætʃ/                ([Casual] 誘拐、ひったくり)     The snatch happened in broad daylight.
  - `seizure` /ˈsiːʒər/             ([Formal] 強奪、拉致)           The illegal seizure was reported.
> `incitement` /ɪnˈsaɪtmənt/        ([Formal] 扇動、教唆)           He was charged with incitement to violence.
  - `aiding and abetting`           ([Legal] 幇助と教唆)            She was guilty of aiding and abetting.
  - `complicity` /kəmˈplɪsəti/      ([Formal] 共犯、加担)           His complicity was proven in court.
  - `instigation` /ˌɪnstɪˈɡeɪʃən/   ([Formal] 教唆、扇動)           The instigation came from outside.
