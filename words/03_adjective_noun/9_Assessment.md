...
> `good` /ɡʊd/                      ([Neutral] 良い)                That's a good idea.
  ...
  - `fine` /faɪn/                   ([Neutral] 良い、立派な)        That's fine by me.
  - `excellent` /ˈeksələnt/         ([Neutral] 優秀な、素晴らしい)  Excellent work!
  - `wonderful` /ˈwʌndərfəl/        ([Neutral] 素晴らしい)          We had a wonderful time.
  - `fantastic` /fænˈtæstɪk/        ([Neutral] 素晴らしい)          That's a fantastic opportunity.
  - `terrific` /təˈrɪfɪk/           ([Neutral] 素晴らしい)          You did a terrific job.
  - `superb` /suːˈpɜːrb/            ([Neutral] 素晴らしい、見事な)  The quality is superb.
> `positive` /ˈpɑːzətɪv/            ([Neutral] 肯定的な、前向きな)  She has a positive attitude.
  - `beneficial` /ˌbenɪˈfɪʃəl/      ([Neutral] 有益な、有利な)      Exercise is beneficial to health.
  - `advantageous` /ˌædvənˈteɪdʒəs/ ([Neutral] 有利な)              This is advantageous for us.
  - `favorable` /ˈfeɪvərəbəl/       ([Neutral] 有利な、好意的な)    Favorable conditions for growth.
  - `constructive` /kənˈstrʌktɪv/   ([Neutral] 建設的な)            That's constructive criticism.
  - `productive` /prəˈdʌktɪv/       ([Neutral] 生産的な、有益な)    We had a productive meeting.
...
> `appall` /əˈpɔːl/                 ([Formal] ぞっとさせる)         The conditions appalled the inspectors.
  - `appalled` /əˈpɔːld/            ([Neutral] 愕然とした)          I was appalled by his behavior.
...
- `passionate` /ˈpæʃənət/         ([Neutral] 情熱的な)            She's passionate about her work.
...
- `hungry` /ˈhʌŋɡri/              ([Casual] 渇望している)         She's hungry for success.
...
> `craving` /ˈkreɪvɪŋ/              ([Neutral] 渇望、切望)          She had a craving for ice cream.
  ...
  - `yearning` /ˈjɜːrnɪŋ/           ([Neutral] 切望、憧れ)          He felt a yearning for freedom.
  - `desire` /dɪˈzaɪər/             ([Neutral] 欲望、願望)          Her desire for success was strong.
  - `urge` /ɜːrdʒ/                  ([Neutral] 衝動、強い欲求)      I had an urge to call her.
  - `appetite` /ˈæpɪtaɪt/           ([Neutral] 欲求、食欲)          He has no appetite for conflict.
...
> `angry` /ˈæŋɡri/                  ([Neutral] 怒った)              She was angry about the delay.
  ...
  - `pissed off` /pɪst ɔːf/         ([Casual] 腹が立った)           I'm really pissed off about this.
  - `fed up` /fed ʌp/               ([Casual] うんざりした)         I'm fed up with this situation.
  - `ticked off` /tɪkt ɔːf/         ([Casual] イライラした)         She's really ticked off about it.
> `furious` /ˈfjʊriəs/              ([Neutral] 激怒した)            My boss was furious about the mistake.
  - `outraged` /ˈaʊtreɪdʒd/         ([Neutral] 憤慨した)            They were outraged by the injustice.
  - `infuriated` /ɪnˈfjʊrieɪtɪd/    ([Neutral] 激怒した)            I was infuriated by their response.
  - `livid` /ˈlɪvɪd/                ([Neutral] 激怒した)            She was livid about the betrayal.
  - `irate` /aɪˈreɪt/               ([Formal] 激怒した)             The irate customer demanded a refund.
  - `enraged` /ɪnˈreɪdʒd/           ([Formal] 激怒した)             The crowd became enraged.
  - `incensed` /ɪnˈsenst/           ([Formal] 激怒した)             They were incensed by the decision.
> `rage` /reɪdʒ/                    ([Neutral] 激怒)                He flew into a rage.
  - `fury` /ˈfjʊri/                 ([Neutral] 激怒、憤怒)          She was filled with fury.
  - `wrath` /ræθ/                   ([Formal] 激怒、怒り)           He faced the wrath of his boss.
  - `ire` /aɪər/                    ([Formal] 怒り)                 Her comments raised his ire.
> `indignant` /ɪnˈdɪɡnənt/          ([Formal] 憤慨した)             She was indignant at the accusation.
  - `exasperated` /ɪɡˈzæspəreɪtɪd/  ([Neutral] うんざりした)        He gave an exasperated sigh.
...
## ALARM / CONCERN
- `alarm` /əˈlɑːrm/                 ([Neutral] 警戒させる、不安)    The symptoms alarmed the doctor.
...
> `fat` /fæt/                       ([Casual] 太い、太った)         He's gotten fat lately.
  > `overweight` /ˌoʊvərˈweɪt/      ([Neutral] 太りすぎの)          The doctor said I'm overweight.
  > `big` /bɪɡ/                     ([Neutral] 大きい)              He's a big guy.
  - `heavy` /ˈhevi/                 ([Neutral] 重い、太った)        He's gotten a bit heavy.
  - `chubby` /ˈtʃʌbi/               ([Casual] ぽっちゃりした)       The baby has chubby cheeks.
  - `plump` /plʌmp/                 ([Neutral] ふっくらした)        She has plump cheeks.
    - `plumpness` /ˈplʌmpnəs/       ([Neutral] ふっくらさ)          The plumpness of the fruit.
  - `thick` /θɪk/                   ([Neutral] 太い、厚い)          He has thick arms.
  - `large` /lɑːrdʒ/                ([Neutral] 大きい、太った)      She wears large sizes.
  ...
  - `bulky` /ˈbʌlki/                ([Neutral] かさばる、大柄な)    He has a bulky frame.
  - `pudgy` /ˈpʌdʒi/                ([Casual] ずんぐりした)         He has pudgy fingers.
  - `tubby` /ˈtʌbi/                 ([Casual] 太っちょの)           The tubby cat needs a diet.
  - `portly` /ˈpɔːrtli/             ([Polite] 恰幅の良い)           The portly gentleman smiled.
  - `rotund` /roʊˈtʌnd/             ([Formal] 丸々とした)           The rotund chef prepared the meal.
  - `corpulent` /ˈkɔːrpjələnt/      ([Formal] 肥満の)               The corpulent man struggled to walk.
  - `obese` /oʊˈbiːs/               ([Medical] 肥満の)              Obesity is a health concern.
  - `flabby` /ˈflæbi/               ([Casual] たるんだ、ぶよぶよの) His arms are flabby.
  - `chunky` /ˈtʃʌŋki/              ([Casual] ずんぐりした)         She has chunky legs.
  - `beefy` /ˈbiːfi/                ([Casual] 肉付きの良い)         The beefy security guard stood watch.
  - `well-fed` /wel fed/            ([Polite] 栄養状態の良い)       He looks well-fed.
  - `full-figured` /fʊl ˈfɪɡərd/    ([Polite] ふくよかな)           She's a full-figured woman.
  - `plus-sized` /plʌs saɪzd/       ([Neutral] 大きいサイズの)      She shops at plus-sized stores.

## TALL / SHORT
> `tall` /tɔːl/                     ([Neutral] 背が高い)            He's tall for his age.
  - `lanky` /ˈlæŋki/                ([Casual] ひょろ長い)           The lanky teenager grew six inches.
  - `towering` /ˈtaʊərɪŋ/           ([Neutral] そびえ立つような)    The towering basketball player smiled.
  - `statuesque` /ˌstætʃuˈesk/      ([Formal] 彫像のような背の高い) The statuesque model walked the runway.
  - `leggy` /ˈleɡi/                 ([Casual] 脚の長い)             The leggy dancer performed gracefully.
  - `gangly` /ˈɡæŋɡli/              ([Casual] ひょろひょろした)     The gangly youth tripped over his feet.
  - `willowy` /ˈwɪloʊi/             ([Writing] しなやかで背の高い)  She has a willowy figure.
  - `elongated` /ɪˈlɔːŋɡeɪtɪd/      ([Formal] 細長い)               His elongated frame filled the doorway.
> `short` /ʃɔːrt/                   ([Neutral] 背が低い)            She's quite short.
  - `small` /smɔːl/                 ([Neutral] 小さい)              She has a small frame.
  - `little` /ˈlɪtəl/               ([Neutral] 小さい)              He's a little guy.
  - `tiny` /ˈtaɪni/                 ([Casual] とても小さい)         She's tiny but fierce.
  - `petite` /pəˈtiːt/              ([Neutral] 小柄な)              She's petite but strong.
  - `diminutive` /dɪˈmɪnjətɪv/      ([Formal] 小柄な、小さな)       The diminutive actress commanded the stage.
  - `pint-sized` /paɪnt saɪzd/      ([Casual] 小柄な)               The pint-sized boxer was tough.
  - `stubby` /ˈstʌbi/               ([Casual] ずんぐりした)         He has stubby fingers.
  - `squat` /skwɑːt/                ([Neutral] ずんぐりした)        The squat building stood out.
  - `undersized` /ˌʌndərˈsaɪzd/     ([Neutral] 小さめの)            The undersized player worked harder.
  - `vertically challenged`         ([Humorous] 背が低い)           He jokes about being vertically challenged.
  - `fun-sized` /fʌn saɪzd/         ([Humorous] 小柄な)             She calls herself fun-sized.
  - `knee-high` /niː haɪ/           ([Casual] 膝丈の、とても小さい) The knee-high fence was easy to step over.
  - `half-pint` /hæf paɪnt/         ([Casual] ちび、小柄な人)       Don't underestimate the half-pint.
  - `dwarfish` /ˈdwɔːrfɪʃ/          ([Old-fashioned] 小人のような)  He had a dwarfish appearance.
  - `lilliputian` /ˌlɪlɪˈpjuːʃən/   ([Literary] 極小の)             Her lilliputian stature belied her strength.

## STRONG / POWERFUL / MUSCULAR
> `strong` /strɔːŋ/                 ([Neutral] 強い、頑丈な)        He has strong arms.
  - `big` /bɪɡ/                     ([Neutral] 大きい、強い)        He's a big strong man.
  - `tough` /tʌf/                   ([Neutral] タフな、頑丈な)      She's tough as nails.
  - `powerful` /ˈpaʊərfəl/          ([Neutral] 力強い)              He has powerful muscles.
  - `muscular` /ˈmʌskjələr/         ([Neutral] 筋肉質な)            He has a muscular build.
  - `fit` /fɪt/                     ([Neutral] 健康的な 引締まった) She's very fit from running.
  - `athletic` /æθˈletɪk/           ([Neutral] 運動選手のような)    She has an athletic body.
  - `built` /bɪlt/                  ([Casual] 体格のいい)           He's really built.
  - `solid` /ˈsɑːlɪd/               ([Neutral] がっしりした)        He has a solid frame.
  - `sturdy` /ˈstɜːrdi/             ([Neutral] 頑丈な)              She has a sturdy build.
  - `robust` /roʊˈbʌst/             ([Formal] 頑健な、たくましい)   He has a robust constitution.
  - `hardy` /ˈhɑːrdi/               ([Neutral] 頑丈な、丈夫な)      She's hardy and resilient.
  - `rugged` /ˈrʌɡɪd/               ([Neutral] 頑丈な、男らしい)    He has rugged good looks.
  - `buff` /bʌf/                    ([Casual] 筋肉隆々の)           He got buff at the gym.
  - `ripped` /rɪpt/                 ([Casual] 筋肉が割れた)         He's totally ripped.
  - `jacked` /dʒækt/                ([Casual] 筋肉隆々の)           He got jacked over the summer.
  - `toned` /toʊnd/                 ([Neutral] 引き締まった)        She has toned abs.
  - `burly` /ˈbɜːrli/               ([Neutral] たくましい)          The burly bouncer checked IDs.
  - `brawny` /ˈbrɔːni/              ([Neutral] 筋骨たくましい)      He has brawny arms.
  - `strapping` /ˈstræpɪŋ/          ([Neutral] 体格の良い)          He's a strapping young man.
  - `mighty` /ˈmaɪti/               ([Neutral] 力強い、強大な)      She has mighty strength.
  - `forceful` /ˈfɔːrsfəl/          ([Neutral] 力強い)              He has a forceful presence.
  - `stalwart` /ˈstɔːlwərt/         ([Formal] 頑丈な、忠実な)       He's a stalwart defender.
  - `sinewy` /ˈsɪnjuːi/             ([Writing] 筋張った 引締まった) His sinewy arms gripped the rope.
  - `well-built` /wel bɪlt/         ([Neutral] 体格の良い)          He's well-built and handsome.
  - `iron` /ˈaɪərn/                 ([Neutral] 鉄のような)          She has an iron will and body.
  - `steely` /ˈstiːli/              ([Neutral] 鋼のような)          He has steely determination.
  - `herculean` /ˌhɜːrkjəˈliːən/    ([Formal] ヘラクレスのような)   He has herculean strength.

## WEAK / FRAGILE / FRAIL
> `weak` /wiːk/                     ([Neutral] 弱い、虚弱な)        She felt weak after the illness.
  - `fragile` /ˈfrædʒəl/            ([Neutral] 壊れやすい、虚弱な)  She looks fragile.
  - `delicate` /ˈdelɪkət/           ([Neutral] 繊細な、か弱い)      She has delicate features.
  - `frail` /freɪl/                 ([Neutral] か弱い、虚弱な)      The elderly woman looked frail.
  - `feeble` /ˈfiːbəl/              ([Neutral] 弱々しい、虚弱な)    His feeble attempt failed.
  - `soft` /sɔːft/                  ([Neutral] 柔らかい、弱い)      He's gotten soft lately.
  - `slight` /slaɪt/                ([Neutral] ほっそりした、華奢な) She has a slight build.
  - `scrawny` /ˈskrɔːni/            ([Casual] 痩せこけた、貧弱な)   The scrawny kid got bullied.
  - `puny` /ˈpjuːni/                ([Casual] ちっぽけな、弱々しい) His puny muscles were no match.
  - `wimpy` /ˈwɪmpi/                ([Casual] 弱虫の、軟弱な)       Don't be so wimpy!
  - `flimsy` /ˈflɪmzi/              ([Neutral] 薄っぺらな、弱い)    His flimsy excuse didn't work.
  - `brittle` /ˈbrɪtəl/             ([Neutral] もろい、壊れやすい)  Her bones are brittle.
  - `vulnerable` /ˈvʌlnərəbəl/      ([Neutral] 傷つきやすい、弱い)  He looks vulnerable.
  - `powerless` /ˈpaʊərləs/         ([Neutral] 無力な)              She felt powerless to help.
  ...
  - `sickly` /ˈsɪkli/               ([Neutral] 病弱な、不健康な)    The sickly child stayed home.
  - `wasted` /ˈweɪstɪd/             ([Neutral] やせ衰えた)          His muscles were wasted away.
  - `atrophied` /ˈætrəfid/          ([Medical] 萎縮した)            His atrophied legs couldn't walk.
  - `withered` /ˈwɪðərd/            ([Neutral] 枯れた、衰えた)      His withered arm hung limp.
...
# ========================================
# VI. SENSATIONS & TEXTURE
# ========================================

## SENSATIONS (TICKLE / ITCH / TINGLE)
...
## PATTERNS (STRIPED / SPOTTED / MOTTLED)
