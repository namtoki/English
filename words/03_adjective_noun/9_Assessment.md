...
## EAGER / CRAVING
> `eager` /ˈiːɡər/                  ([Neutral] 熱望する)            She was eager to start the project.
  ...
  - `ardent` /ˈɑːrdnt/              ([Formal] 熱烈な)               She's an ardent supporter of the cause.
  - `fervent` /ˈfɜːrvənt/           ([Formal] 熱烈な、熱心な)       He made a fervent plea for help.
  - `zealous` /ˈzeləs/              ([Formal] 熱心な)               The zealous volunteers worked tirelessly.
  - `avid` /ˈævɪd/                  ([Neutral] 熱心な、貪欲な)      She's an avid reader.
  - `keen` /kiːn/                   ([Neutral] 熱心な、鋭い)        He's keen on learning new skills.
...
## ANNOYED / ANGRY / FURIOUS / RAGE / INDIGNANT
...
> `strong` /strɔːŋ/                 ([Neutral] 強い、頑丈な)        He has strong arms.
  ...
  - `vigorous` /ˈvɪɡərəs/           ([Formal] 活力ある、元気な)     She's vigorous and healthy.
