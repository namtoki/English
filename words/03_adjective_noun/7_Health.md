...
- `body` /ˈbɑːdi/                   ([Neutral] 死体、遺体)          They found the body in the river.
  - `corpse` /kɔːrps/               ([Neutral] 死体)                The corpse was discovered at dawn.
  - `remains` /rɪˈmeɪnz/            ([Neutral] 遺体、遺骨)          The remains were returned to the family.
  - `deceased` /dɪˈsiːst/           ([Formal] 故人、死者)           The deceased was a war hero.
  - `cadaver` /kəˈdævər/            ([Medical] 死体、献体)          Medical students study cadavers.
  - `carcass` /ˈkɑːrkəs/            ([Neutral] 死体、屍)            The animal carcass attracted vultures.
...
- `digestive tract`                 ([Medical] 消化管)              The digestive tract processes food.
  - `digestive` /daɪˈdʒestɪv/       ([Medical] 消化の)              The digestive system is complex.
  - `gastrointestinal`              ([Medical] 胃腸の)              She has gastrointestinal issues.
  - `enteric` /enˈterɪk/            ([Medical] 腸の)                Enteric bacteria live in the gut.
- `stomach` /ˈstʌmək/               ([Neutral] 胃、お腹)            His stomach hurt after eating.
  - `gastric` /ˈɡæstrɪk/            ([Medical] 胃の)                He had gastric problems.
- `gut` /ɡʌt/                       ([Casual] 腸、内臓)             Trust your gut on this decision.
  - `intestine` /ɪnˈtestɪn/         ([Medical] 腸)                  The small intestine absorbs nutrients.
  - `intestinal` /ɪnˈtestɪnəl/      ([Medical] 腸の、腸内の)        He has an intestinal infection.
  - `bowel` /ˈbaʊəl/                ([Medical] 腸)                  She has bowel problems.
  - `small intestine`               ([Medical] 小腸)                The small intestine is very long.
