...
## ILLNESS (SICKNESS / AILMENT / SYMPTOM / HEREDITY)
...
> `anatomy` /əˈnætəmi/              ([Neutral] 解剖学、構造)        She's studying human anatomy.
  - `anatomical` /ˌænəˈtɑːmɪkəl/    ([Medical] 解剖学的な)          The anatomical model is accurate.
  - `physiology` /ˌfɪziˈɑːlədʒi/    ([Medical] 生理学)              Physiology studies body functions.
  - `morphology` /mɔːrˈfɑːlədʒi/    ([Medical] 形態学)              Cell morphology reveals disease.
