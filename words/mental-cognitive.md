...
This category contains words related to thinking, learning, understanding, and mental activities.
...
- `figment` /ˈfɪɡmənt/              ([Neutral] 想像上のもの)        That monster is just a figment of your imagination.
- `illusion` /ɪˈluːʒən/             ([Neutral] 錯覚、幻想)          The magician created an optical illusion.
  ...
  - `disillusion` /ˌdɪsɪˈluːʒən/  ([Writing] 幻滅させる)          The scandal will disillusion his supporters.
    - `disillusioned` /ˌdɪsɪˈluːʒənd/ ([Writing] 幻滅した)            She became disillusioned with politics.
    - `disillusionment` /ˌdɪsɪˈluːʒənmənt/ ([Writing] 幻滅)        His disillusionment was complete.
- `fantasy` /ˈfæntəsi/              ([Neutral] 幻想、空想)          Living in a castle is just a fantasy.
  ...
  - `fantastic` /fænˈtæstɪk/        ([Casual] 素晴らしい、空想的)   That's a fantastic idea!
- `delusion` /dɪˈluːʒən/            ([Writing] 妄想、錯覚)          He was under the delusion he could fly.
  - `delusional` /dɪˈluːʒənəl/       ([Writing] 妄想的な)            Her beliefs were completely delusional.
