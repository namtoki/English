...
This category contains words related to time, timing, duration, and chronological order.
...
- `extinct` /ɪkˈstɪŋkt/             ([Neutral] 絶滅した、消滅した)  Dinosaurs became extinct millions of years ago.
  - `extinction` /ɪkˈstɪŋkʃən/      ([Neutral] 絶滅、消滅)          Many species face extinction.
  - `extinguish` /ɪkˈstɪŋɡwɪʃ/      ([Formal] 消す、絶やす)         They extinguished the fire quickly.
