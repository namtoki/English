...
- `rainy day fund`                  ([Casual] いざという時の蓄え)   Keep some money for a rainy day fund.
...
- `wage` /weɪdʒ/                    ([Neutral] 賃金)                The minimum wage has increased.
  - `wages` /ˈweɪdʒɪz/              ([Neutral] 賃金)                Factory workers receive weekly wages.
- `profit` /ˈprɒfɪt/                ([Neutral] 利益)                The profit was higher than expected.
- `bonus` /ˈboʊnəs/                 ([Neutral] ボーナス)            I got a bonus for good performance.
