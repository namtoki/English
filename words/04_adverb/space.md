...
- `out front`                       ([Casual] 前の外に)             I'll meet you out front.
- `leading`                         ([Neutral] 先頭の)              The leading car in the race.
- `face to face`                    ([Neutral] 対面で)              We met face to face.
- `vis-à-vis`                       ([Formal] 〜に対して)           Vis-à-vis the competition.
...
- `lower` /ˈloʊər/                  ([Neutral] より低い)            The lower shelf.
...
- `underground` /ˌʌndərˈɡraʊnd/     ([Neutral] 地下の)              The underground parking.
- `below ground` /bɪˈloʊ ɡraʊnd/    ([Neutral] 地下に)              Six feet below ground.
...
- `at ground level` /ɡraʊnd ˈlevəl/ ([Neutral] 地上レベルで)        At ground level.
