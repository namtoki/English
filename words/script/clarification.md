  ...
  think, understand, remember, learn, analyze, investigate, decide, believe

  3. emotions-feelings.md - 感情・気持ち
  happy, sad, angry, excited, afraid, nervous, enthusiastic, passionate

  4. difficulty-challenge.md - 困難・挑戦
  difficult, hard, challenging, complex, arduous, easy, simple

  5. conflict-warfare.md - 紛争・戦争
  attack, defend, invasion, siege, battle, war, fight, assault
  ...
  money, spend, save, profit, expensive, cheap, buy, sell, cost

  9. physical-properties.md - 物理的性質
  hard, soft, strong, weak, solid, dense, fragile, smooth, heavy

  10. position-location.md - 位置・場所
  high, low, above, below, near, far, inside, outside, center
  ...
  food, eat, drink, cook, meal, fruit, vegetable, delicious, hungry

  16. house-home.md - 家・住居
  house, home, room, kitchen, furniture, table, chair, window, door

  17. work-profession.md - 仕事・職業
  work, job, teacher, doctor, engineer, office, business, company

  18. nature-environment.md - 自然・環境
  tree, animal, weather, rain, mountain, river, forest, climate
