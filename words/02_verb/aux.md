...
> `meant to` /ment tuː/             ([Neutral] ～するつもり)        I meant to call you earlier.
...
## EMPHASIS (FINALLY GET TO / END UP -ING / )
> `finally get to`                  ([Neutral] ついに～する)        I finally got to meet her.
  - `get down to` /ɡet daʊn tuː/    ([Neutral] ～に取り掛かる)      Let's get down to business.
...
> `still manage to`                 ([Neutral] それでもしてしまう)  I still manage to make mistakes.
  ...
  - `take the leap` /teɪk ðə liːp/  ([Neutral] 飛び込む)            They took the leap into marriage.
  - `dive in` /daɪv ɪn/             ([Casual] 飛び込む)             Don't overthink it, just dive in!
