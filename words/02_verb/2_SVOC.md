...
> `see` /siː/                       ([Neutral] 見る)                I saw him run.
  ...
  - `notice` /ˈnoʊtɪs/              ([Neutral] 気づく)              I noticed her leave.
...
> `make O V`                        ([強制的] OにVさせる)           The movie made me cry.
  ...
  - `have O V`                      ([指示/依頼] OにVさせる)        I'll have him call you back.
  - `have O C`                      ([状態維持] OをCの状態に保つ)   I have my room clean.
...
> `consider` /kənˈsɪdər/            ([Neutral] だと思う、考慮する)  I consider him a good friend.
  ...
  - `believe` /bɪˈliːv/             ([Neutral] 信じる)              I believe her honest.
  - `judge` /dʒʌdʒ/                 ([Neutral] 判断する)            I judge him qualified.
  - `deem` /diːm/                   ([Formal] 見なす)               We deem it necessary.
  - `regard` /rɪˈɡɑːrd/             ([Formal] 見なす)               I regard him as a friend.
...
> `keep` /kiːp/                     ([Neutral] 保つ、維持する)      Keep your room clean.
  ...
  - `drive` /draɪv/                 ([Neutral] ～の状態にする)      This noise drives me crazy.
  - `turn` /tɜːrn/                  ([Neutral] ～に変える)          They turned the room blue.
  - `paint` /peɪnt/                 ([Neutral] 塗る)                We painted the wall white.
  - `make` /meɪk/                   ([Neutral] ～にする)            This makes me happy.
  - `render` /ˈrendər/              ([Formal] ～にする)             The accident rendered him helpless.
