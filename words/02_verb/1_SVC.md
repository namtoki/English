...
> `be` /biː/                        ([Neutral] ～である)            She is a teacher.
  ...
  - `sound` /saʊnd/                 ([Neutral] ～に聞こえる)        That sounds great.
  - `smell` /smel/                  ([Neutral] ～の匂いがする)      This smells delicious.
  - `taste` /teɪst/                 ([Neutral] ～の味がする)        It tastes sweet.
  - `feel` /fiːl/                   ([Neutral] ～に感じる)          I feel embarrassed.
  - `prove` /pruːv/                 ([Neutral] ～だと判明する)      The plan proved successful.
...
> `become` /bɪˈkʌm/                 ([Neutral] ～になる)            She became a doctor.
  ...
  - `grow` /ɡroʊ/                   ([Neutral] ～になる)            The crowd grew restless.
  - `go` /ɡoʊ/                      ([Neutral] ～になる)            The milk went bad.
  - `come` /kʌm/                    ([Neutral] ～になる)            Her dreams came true.
  - `fall` /fɔːl/                   ([Neutral] ～になる)            He fell asleep.
  - `run` /rʌn/                     ([Neutral] ～になる)            Supplies are running low.
...
> `remain` /rɪˈmeɪn/                ([Formal] ～のままである)       She remained calm.
  ...
  - `lie` /laɪ/                     ([Neutral] ～の状態である)      The town lies deserted.
  - `sit` /sɪt/                     ([Neutral] ～の状態である)      The house sits empty.
